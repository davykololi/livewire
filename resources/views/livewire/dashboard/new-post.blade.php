            ...
            <div class="px-4 py-3 space-y-8 sm:p-6">
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <x-jet-input type="text" class="w-full" wire:model="post.desc" placeholder="Description" />
                        <x-jet-input-error for="post.desc" />
                    </div>
                </div>
                <div class="grid grid-cols-6 gap-6">
                    <div class="col-span-6 sm:col-span-3">
                ...
                <div class="flex flex-col">
                    ...
                    <textarea id="content" rows="4" wire:model="post.content" class="border-gray-300 rounded-sm form-textarea"></textarea>
