<div class="p-4 mx-auto mt-3 bg-gray-100 md:p-8 md:w-4/5 md:mt-0">
    <h1 class="mb-3 text-xl font-semibold text-gray-600 uppercase">New post</h1>
    @can('isAuthor')
        <div class="mb-5 text-right">
            <a href="{{ url('author/posts') }}" class="px-4 py-1 text-white text-center bg-blue-400 rounded-full shadow-lg uppercase font-extrabold border-2 hover:bg-purple-500">
            	Posts
            </a>
        </div>
    @endcan
            ...
            <div class="px-4 py-3 space-y-8 sm:p-6">
                ...
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <x-jet-input type="file" class="w-full" wire:model="image"/>
                ...
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <x-jet-input id="tags" wire:model="tags" type="text" placeholder="Tags" class="w-full"/>
