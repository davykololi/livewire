		  <aside class="bg-gradient-to-l from-red-300 to-red-800 via-orange-500 lg:bg-gradient-to-r from-red-300 to-red-800 via-orange-500 lg:w-1/3 mx-0 lg:mr-2 lg:ml-0 lg:shadow-lg lg:shadow-blue-900/50 block shrink-0 px-2">
          <div class="overflow-hidden p-4">
            <form>   
              ...
              <div class="relative">
                ...
                <input type="search" id="search" class="block p-4 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-red-500 focus:border-red-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" placeholder="Search" required>
