<footer class="bg-red-900">
    <div class="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4 border-t-8 border-white">
        <div>
            ...
            <ul class="text-gray-300">
                <li class="mb-4">
                    <a href="<?php echo e(route('about.us')); ?>" class=" hover:underline">About</a>
                </li>
                <li class="mb-4">
        ...
        <div>
            ...
            <ul class="text-gray-300">
                ...
                <li class="mb-4">
                    <a href="<?php echo e(route('contact.us')); ?>" class="hover:underline">Contact Us</a>
                </li>
            </ul>
        </div>
        <div>
    ...
    <div class="py-6 px-4 bg-gray-700 md:flex md:items-center md:justify-between">
        <span class="text-sm text-gray-300 sm:text-center">© 2022 <a href="https://flowbite.com"><?php echo e(config('app.name')); ?>™</a>
            . All Rights Reserved.
        </span>
...
<?php /**PATH C:\xampp\htdocs\projects\livewire\livewire\resources\views/frontend/footer.blade.php ENDPATH**/ ?>