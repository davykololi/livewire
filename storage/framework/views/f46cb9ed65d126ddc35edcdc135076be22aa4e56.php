...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.application-logo','data' => ['class' => 'w-24 h-24']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
