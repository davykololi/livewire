    ...
    <div class="flex-grow w-full transition-all duration-500 ease-in lg:flex lg:items-center lg:w-auto"
        ...
        <ul class="items-center justify-start flex-1 pt-4 space-y-4 lg:pt-0 list-reset lg:flex lg:space-y-0">
            ...
            <li class="py-2 md:py-0">
                <a href="<?php echo e(url('author/posts')); ?>" class="mx-4 text-sm text-bold hover:text-indigo-500 uppercase">Posts</a>
            </li>
            <?php endif; ?>
        </ul>
        ...
        <ul class="items-center justify-end flex-1 pt-4 space-y-4 lg:pt-0 list-reset lg:flex lg:space-y-0">
            ...
            <li class="py-2 md:py-0">
                <a href="<?php echo e(route('login')); ?>" class="mx-4 text-lg hover:text-indigo-500">
                    Signin
                </a>
            </li>
            <?php endif; ?>
            ...
            <li class="py-2 md:py-0">
                <a href="<?php echo e(route('register')); ?>" class="mx-4 text-lg hover:text-indigo-500">
                    Signup
                </a>
            </li>
            <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\projects\livewire\livewire\resources\views/components/author-nav.blade.php ENDPATH**/ ?>